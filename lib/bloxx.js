...
(function (global, factory) {
	...
	BLOXX.ModelMixin = {
		initializePrototype: function initializePrototype() {
			...
			Object.freeze(this.relationshipDefinitions);
	...
	BLOXX.Registry = BLOXX.factory({
		...
		createModel: function (mixin) {
			var constructor = BLOXX.factory([BLOXX.BaseModelMixin, BLOXX.ModelMixin], mixin);
			constructor.prototype.initializePrototype();
